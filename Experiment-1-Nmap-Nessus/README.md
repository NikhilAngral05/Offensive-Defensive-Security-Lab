...
Wait for Nessus to complete the scanning process.
Nessus checks the target system and its available services.
The scan identifies possible security weaknesses.
Open the completed scan to view the detailed results.
